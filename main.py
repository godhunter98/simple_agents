...
class Agent:
    def __init__(self, client,system:str="",tools:Optional[List[Dict[str,Any]]] = None) -> None :
        ...
        if tools:
            ...
            self.function_map = {tool['schema']['function']['name']: tool['function'] for tool in tools}
        else:
            self.tools = []
            self.function_map = {}
        if self.system:
        ...
        while True:
            ...
            if response_message.tool_calls:
                ...
                for tool_call in response_message.tool_calls:
                    ...
                    function_args = raw_args if isinstance(raw_args, dict) else json.loads(raw_args or "{}")
